...
public class ModelManager {
    ...
    public void generateResourcePack(File target) {
        Bukkit.getLogger().log(Level.INFO, "Generating resource pack for {0} models.", this.models.size());

        ResourcePack pack = ResourcePack.fromFile(target, true);
        ...
        ItemModel model = pack.getItemModel("minecraft", "item/leather_horse_armor.json");
        ...
        Bukkit.getLogger().log(Level.INFO, "Resource pack generation complete.");
    }
}
